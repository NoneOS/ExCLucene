...
CL_NS_USE(index)
	...
	void QueryTermExtractor::getTerms(const Query * query, WeightedTermList * terms, 
                                     bool prohibited, const TCHAR* fieldName) 
	{
...
// 			getTermsFromFilteredQuery((FilteredQuery *) query, terms);
	...
	/**
  	...
  	*/
  	WeightedTerm** QueryTermExtractor::getIdfWeightedTerms(const Query* query, 
                                                             IndexReader* reader, 
                                                             const TCHAR* fieldName)
  	{
	...
	void QueryTermExtractor::getTermsFromBooleanQuery(const BooleanQuery * query, 
                                                     WeightedTermList * terms, 
                                                     bool prohibited, 
                                                     const TCHAR* fieldName)
	{
...
// FilteredQuery not implemented yet
//     void QueryTermExtractor::getTermsFromFilteredQuery(const FilteredQuery * query, 
//    WeightedTermList * terms, bool prohibited)
//     {
