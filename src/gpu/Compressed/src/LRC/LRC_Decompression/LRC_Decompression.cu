...
#include "LRC_Decompression_kernel.cu"
...
string result_dir = "/media/indexDisk/naiyong/result/LRC/Decompression/";
...
void kernelInvoke(const batchInfo &bi) {
	...
	LRC_Decompression<<<bi.blockNum, THREAD_NUM>>>(d_lists, d_queryID_perBlock, d_shortest_lists, d_segOffset, d_linearInfo);
...
int main(int argc, char** argv)  {
	...
	string dataset = argv[1];
	cout << "LRC_Decompression" << endl;
	cout << "dataset = " << dataset << endl;

	string result = result_dir + dataset + "_LRC_Decompression.txt";
