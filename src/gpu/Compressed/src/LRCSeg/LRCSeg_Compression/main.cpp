/*************************************************************************
	...
	> Time: Thu 29 Jan 2015 12:18:39 AM CST
 ************************************************************************/
#include <stdio.h>
#include <stdint.h>
#include <stdlib.h>
...
string result_dir = "/media/indexDisk/naiyong/result/LRCSeg/Compression/";
...
int main(int argc, char** argv) {
	...
	cout << "LRCSeg_Compression" << endl;
	cout << "dataset = " << dataset << endl;

	string result_filename = result_dir + dataset + "_LRCSeg_Compression.txt";
