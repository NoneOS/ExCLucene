/*************************************************************************
	...
	> Time: Wed 28 Jan 2015 11:42:17 PM CST
 ************************************************************************/
#include <stdint.h>
#include <string.h>
#include <stdio.h>
...
string result_dir = "/media/indexDisk/naiyong/result/ParaPFD/Compression/";
...
int main(int argc, char** argv) {
	...
	cout << "ParaPFD_Compression" << endl;
	cout << "dataset = " << dataset << endl;

	string result_filename = result_dir + dataset + "_ParaPFD_Compression.txt";
