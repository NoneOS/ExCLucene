...
#include "ParaPFD_Decompression_kernel.cu"

using namespace std;


string dataset_dir = "/media/indexDisk/naiyong/dataset/";
string data_dir = "/media/indexDisk/naiyong/data/ParaPFD/Compression/"; 
string result_dir = "/media/indexDisk/naiyong/result/ParaPFD/Decompression/";
...
void kernelInvoke(const batchInfo &bi) {
	...
	ParaPFD_Decompression<<<bi.blockNum, THREAD_NUM>>>(d_lists, d_queryID_perBlock, d_shortest_lists, d_segOffset, d_segHead);
...
int main(int argc, char** argv)  {
	...
	string dataset = argv[1];
	cout << "ParaPFD_Decompression" << endl;
	cout << "dataset = " << dataset << endl;

	string result = result_dir + dataset + "_ParaPFD_Decompression.txt";
