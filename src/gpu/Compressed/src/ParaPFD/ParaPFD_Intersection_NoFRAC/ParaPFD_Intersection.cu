...
string data_dir = "/media/indexDisk/naiyong/data/ParaPFD/Compression/0/";
...
void Run(const string &dataset, unsigned char *ptr_in, unsigned char *ptr_end) {
	string result = result_dir + dataset + "_ParaPFD_Intersection_NoFRAC.txt";
...
void runTest(int argc, char** argv) {
	...
	cout << "ParaPFD_Intersection_NoFRAC" << endl;
