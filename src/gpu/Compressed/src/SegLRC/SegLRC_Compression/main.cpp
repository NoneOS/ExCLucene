/*************************************************************************
	...
	> Time: Fri 30 Jan 2015 08:26:41 PM CST
 ************************************************************************/
#include <stdio.h>
#include <stdint.h>
#include <stdlib.h>
...
string result_dir = "/media/indexDisk/naiyong/result/SegLRC/Compression/";
...
void Compression(const string &dataset) {
	...
	sprintf(file_name, "%s%s%s", regressioninfo_dir.c_str(), dataset.c_str(), ".regression_info_list");
	stat(file_name, &buf);
	compSize += buf.st_size;
...
int main(int argc, char** argv) {
	...
	cout << "SegLRC_Compression" << endl;
	cout << "dataset = " << dataset << endl;

	string result_filename = result_dir + dataset + "_SegLRC_Compression.txt";
