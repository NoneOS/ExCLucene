...
#include "SegLRC_Decompression_kernel.cu"

using namespace std;


string dataset_dir = "/media/indexDisk/naiyong/dataset/";
string data_dir = "/media/indexDisk/naiyong/data/SegLRC/Compression/";
string regressioninfo_dir = "/media/indexDisk/naiyong/data/SegLRC/Generator/";
string result_dir = "/media/indexDisk/naiyong/result/SegLRC/Decompression/";
...
void kernelInvoke(const batchInfo &bi) {
	...
	SegLRC_Decompression<<<bi.blockNum, THREAD_NUM>>>(d_lists, d_queryID_perBlock, d_shortest_lists, d_segOffset, d_regression_info, d_base);
...
int main(int argc, char** argv)  {
	...
	string dataset = argv[1];
	cout << "SegLRC_Decompression" << endl;
	cout << "dataset = " << dataset << endl;

	string result = result_dir + dataset + "_SegLRC_Decompression.txt";
